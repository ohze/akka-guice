...
class ParentActor @Inject() (val injector: Injector, fact: AssistedChildActor.Factory) extends Actor with ActorInject {
  ...
  private val assistedChild2 = injectActor(fact(2, "arg2 value"), "assistedChild2")
